# ZRC-ND Phase A RFQ Send Confirmation Intake

This report scans original RFQ send confirmations. It is not measured evidence.

**Status:** `zrc_nd_phase_a_rfq_send_confirmation_intake_waiting_for_confirmation_files`
**Send confirmation directory:** `data/rfq_send_confirmation_files/zrc_phase_a`
**Send log CSV:** `data/zrc_nd_phase_a_rfq_send_log.csv`
**Intake CSV:** `data/zrc_nd_phase_a_rfq_send_confirmation_intake.csv`
**Files scanned:** 0
**Applied rows:** 0
**Needs review:** 0
**Unmatched:** 0
