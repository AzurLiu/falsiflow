    ...
    if pyproject_path.exists():
        ...
        launch_execution_has_current_copy = all(
            ...
            for token in [
                ...
                "completed seed issues #26, #27, #28, #29, #30, #31, #32, #33, #34, and #35",
                "open PR #17",
                "issue #36",
