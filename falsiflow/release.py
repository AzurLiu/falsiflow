    ...
    if pyproject_path.exists():
        ...
        launch_execution_has_current_copy = all(
            ...
            for token in [
                ...
                "0 stars",
                "2 forks",
                "open issues #22 and #34",
                "completed seed issues #26, #27, #28, #29, #30, #31, #32, and #33",
                "open PR #17",
                "issue #34",
                "local LLM proof snippet",
                "issue #33",
