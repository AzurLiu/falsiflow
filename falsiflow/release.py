...
def package_release_checks(root: Path) -> dict[str, object]:
    ...
    if pyproject_path.exists():
        ...
        add("launch_execution_docs", all(token in launch_execution_text for token in ["Falsiflow Launch Execution", "v0.1.17 pre-public-post baseline", "0 stars", "2 forks", "open issue #22 only", "open PR #17 only", "26716828570", "pre-launch seed queue is complete", "24-hour post-public-post metrics review", "claim_check_blocked", "claim_check_ready"]), "Launch execution doc records the current v0.1.17 pre-public-post baseline, completed seed queue, external evidence, and blocked-to-ready launch copy.", launch_execution_path)
