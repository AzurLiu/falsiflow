...
EXPECTED_PROJECT_URLS = {
    ...
    "Demo": "https://falsiflow-demo.netlify.app",
...
def package_release_checks(root: Path) -> dict[str, object]:
    ...
    if pyproject_path.exists():
        ...
        add(
            ...
            "Project metadata links homepage, docs, architecture, data contract, adapter profiles, casebook check, template authoring, troubleshooting, source, issues, changelog, demo, citation, and governance URLs.",
            pyproject_path,
        )
        ...
        add("readme_adapter_profiles_entry", all(token in readme_text for token in ["falsiflow_adapter_profiles.md", "vendor-measurement", "instrument-export", "plate-reader"]), "README links adapter profile guidance for vendor, instrument, and plate-reader CSV imports.", readme_path)
        ...
        add("readme_positioning_entry", all(token in readme_text for token in ["falsiflow_positioning.md", "spreadsheets", "ELN/LIMS", "workflow orchestrators"]), "README links the positioning and comparison casebook.", readme_path)
        add("readme_public_casebook_entry", all(token in readme_text for token in ["falsiflow_public_casebook.md", "Biointerface", "AI claim", "vendor", "wetware"]), "README links the public casebook and names its starter-template coverage.", readme_path)
        ...
        add("readme_first_screen_story", all(token in readme_first_screen for token in ["AI eval", "product metric", "R&D", "falsiflow quickstart --template ai_claim_evaluation", "quickstart_ready", "claim_check_ready", "claim_check_blocked", "GitHub Action", "Public demo"]), "README first screen names broad use cases, public demo, AI-claim quickstart, blocked placeholder behavior, and GitHub Action adoption.", readme_path)
        ...
        add("launch_kit_docs", all(token in readme_text for token in ["falsiflow launch-kit", "launch_summary.json", "proof_card.md", "announcement.md", "demo_script.md", "readme_proof_strip.svg", "social_preview.svg", "github_repo_profile.md", "launch_posts.md", "launch_metrics.json", "launch_metrics.md", "public_release_evidence.md", "release_rehearsal.md", "maintainer_checklist.md"]), "README documents public launch materials, proof-card generation, social preview, repo profile, launch posts, launch metrics, publish evidence ledger, release rehearsal, and README proof-strip asset.", readme_path)
        add("launch_metrics_docs", all(token in readme_text + adoption_priorities_text + roadmap_text for token in ["launch metrics tracker", "GitHub traffic", "referrers", "stars", "forks", "clones", "demo visits", "install/download signals"]), "README, adoption priorities, and roadmap document post-launch metrics tracking for the 1k-star path.", readme_path)
        add("external_check_docs", all(token in readme_text for token in ["falsiflow external-evidence", "falsiflow external-check", "external_readiness.json", "external_ready", "external_blocked", "--evidence", "FALSIFLOW_EXTERNAL_EVIDENCE", "FALSIFLOW_PYPI_PACKAGE_URL", "https://pypi.org/pypi/falsiflow/json", "FALSIFLOW_PIPX_PUBLIC_VALIDATED", "public-package pipx", "Falsiflow External Evidence", "falsiflow_external_evidence.json"]), "README documents structured external evidence, public package evidence, PyPI JSON verification, CI evidence capture, and publication readiness checks.", readme_path)
        add("readme_github_action_docs", all(token in readme_text for token in ["action.yml", f"uses: AzurLiu/falsiflow@v{current_version}", "mode: claim-check", "install-command", "template-check", "external-check"]), "README documents downstream reusable GitHub Action adoption and local checkout install override.", readme_path)
        ...
        add("github_action_entrypoint", all(token in action_text for token in ["using: composite", "actions/setup-python@v5", "install-command", "mode", "claim-check", "template-check", "casebook-check", "release-check", "adoption-check", "quickstart", "external-check", "summary-json", "GITHUB_OUTPUT"]), "Reusable GitHub Action exposes supported Falsiflow gates, Python setup, install override, and output metadata.", action_path)
        ...
        add("github_external_evidence_workflow", all(token in github_external_evidence_text for token in ["Falsiflow External Evidence", "public_demo_url", "pypi_package_url", "Verify PyPI project URL", "https://pypi.org/pypi/falsiflow/json", "falsiflow_pypi_project.json", "pipx-smoke", "pipx-public-package", "windows-powershell", "pypi_package_url", "pipx_public_package", "falsiflow_external_evidence.json", "external-check", "upload-artifact"]), "GitHub Actions external-evidence workflow captures hosted demo, PyPI JSON package proof, checkout pipx, public-package pipx, Windows, and external-check artifacts for public readiness proof.", github_external_evidence_path)
        add("github_scorecard_workflow", all(token in github_scorecard_text for token in ["Falsiflow Scorecard", "ossf/scorecard-action@v2.4.3", "results_format: sarif", "publish_results: false", "scorecard-results.sarif", "github/codeql-action/upload-sarif", "security-events: write", "id-token: write"]), "GitHub Actions Scorecard workflow records OpenSSF Scorecard SARIF security signals without publishing to the Scorecard webapp under SARIF upload permissions.", github_scorecard_path)
        ...
        add("template_gallery_docs", all(token in readme_text for token in ["template-gallery", "Falsiflow Template Gallery", "rfq_vendor_evidence", "biointerface_coatings", "wetware_support_hardware", "ai_claim_evaluation"]), "README documents the template gallery and cross-domain starter breadth.", readme_path)
        ...
        add("release_checklist", all(token in release_text for token in ["release_ready", "package_ready", "dist_ready", "release_validation_ready", "demo_package_ready", "publish_kit_ready", "launch_kit_ready", "launch_metrics.json", "launch_metrics.md", "public_release_evidence.json", "public_release_evidence.md", "release_rehearsal.json", "release_rehearsal.md", "public release rehearsal", "casebook_check_ready", "external-evidence", "external_check_status", "public PyPI package URL", "PyPI JSON API", "falsiflow_pypi_project.json", "invalid-publisher", "falsiflow-publish.yml", "public-package pipx", "Falsiflow External Evidence", "falsiflow_external_evidence.json", "release-check", "casebook-check", "Release Review Artifact Index", "Review Artifact Index", "PyPI package metadata", "requires-python", "classifiers", "project URLs", "action.yml", "GitHub Action", "reusable-action quickstart smoke", "CODE_OF_CONDUCT.md", "SUPPORT.md", "ROADMAP.md", "CITATION.cff", "GOVERNANCE.md", "falsiflow_architecture.md", "falsiflow_data_contract.md", "falsiflow_adapter_profiles.md", "falsiflow_casebook_check.md", "falsiflow_security_posture.md", "falsiflow_template_authoring.md", "falsiflow_troubleshooting.md", "Dependabot", "Falsiflow Scorecard"]), "RELEASE.md documents required release gates, review artifact indexes, launch metrics, public release evidence ledger, release rehearsal, reusable GitHub Action, public package and PyPI JSON evidence, PyPI trusted-publisher recovery, casebook proof artifacts, external evidence workflow artifacts, package metadata checks, community trust files, citation/governance files, architecture docs, data-contract docs, adapter-profile docs, template authoring docs, troubleshooting docs, and security automation.", release_path)
        ...
        add("adapter_profiles_docs", all(token in adapter_profiles_text for token in ["Falsiflow Adapter Profiles", "generic-wide", "vendor-measurement", "instrument-export", "plate-reader", "adapter_profile", "adapter_settings"]), "Adapter profile doc explains built-in CSV import profiles, summary fields, overrides, and coverage checks.", adapter_profiles_path)
        ...
        add("cli_reference_docs", all(token in cli_reference_text for token in ["Falsiflow CLI Reference", "falsiflow start", "falsiflow cli-reference", "falsiflow release-check", "falsiflow external-evidence", "falsiflow evidence import", "falsiflow template-release"]), "Generated CLI reference documents first-run, release, external evidence, import, and template commands.", cli_reference_path)
        add("positioning_casebook", all(token in positioning_text for token in ["Comparison Map", "Casebook", "Spreadsheet checklist", "CI test suite", "ELN or LIMS", "ML eval harness", "Materials database", "Workflow orchestrator", "Decision Rubric"]), "Positioning doc explains when Falsiflow fits and how it differs from adjacent tools.", positioning_path)
        add("public_casebook", all(token in public_casebook_text for token in ["Falsiflow Public Casebook", "Biointerface Coating Screen", "Neural Materials Interface", "AI Claim Evaluation", "Vendor Or External-Lab Handoff", "Wetware Support Hardware", "ai_claim_evaluation", "Blocked-path proof", "Reviewer Rubric", "casebook_reviewer_replay.sh", "casebook_reviewer_replay.ps1", "falsiflow claim-check"]), "Public casebook documents concrete starter-template stories, blocked-path proofs, reviewer replay artifacts, and demo commands.", public_casebook_path)
        add("pypi_trusted_publishing_docs", all(token in pypi_trusted_publishing_text + readme_text + troubleshooting_text for token in ["Falsiflow PyPI Trusted Publishing", "invalid-publisher", "repo:AzurLiu/falsiflow:environment:pypi", "falsiflow-publish.yml", "environment `pypi`", "https://pypi.org/pypi/falsiflow/json"]), "PyPI trusted publishing runbook documents the current account-bound publisher claim, required PyPI settings, and verification path.", pypi_trusted_publishing_path)
        ...
        add("manifest_release_docs", all(token in manifest_text for token in ["CHANGELOG.md", "CONTRIBUTING.md", "CITATION.cff", "CODE_OF_CONDUCT.md", "GOVERNANCE.md", "RELEASE.md", "SECURITY.md", "SUPPORT.md", "RESPONSIBLE_USE.md", "ROADMAP.md", "examples/README.md", "docs/falsiflow_adoption_priorities.md", "docs/falsiflow_architecture.md", "docs/falsiflow_cli_reference.md", "docs/falsiflow_data_contract.md", "docs/falsiflow_adapter_profiles.md", "docs/falsiflow_casebook_check.md", "docs/falsiflow_positioning.md", "docs/falsiflow_public_casebook.md", "docs/falsiflow_pypi_trusted_publishing.md", "docs/falsiflow_security_posture.md", "docs/falsiflow_template_authoring.md", "docs/falsiflow_troubleshooting.md", "docs/assets", "scripts/install_local.sh", "scripts/install_local.ps1", "Makefile", "action.yml", ".github/workflows", ".github/ISSUE_TEMPLATE", ".github/PULL_REQUEST_TEMPLATE.md", ".github/dependabot.yml"]), "MANIFEST.in includes release, security, support, conduct, roadmap, responsible-use, citation, governance, walkthrough, architecture, CLI reference, data contract, adapter profiles, casebook check, positioning, public casebook, PyPI trusted publishing, security posture, template authoring, troubleshooting, README visual assets, installers, Makefile, reusable GitHub Action, workflows, community templates, dependency automation, and adoption docs in source distributions.", manifest_path)
        ...
        try:
            ...
            add(
                ...
                "Installed metadata links homepage, docs, architecture, data contract, adapter profiles, casebook check, template authoring, troubleshooting, source, issues, changelog, demo, citation, and governance URLs.",
                root,
            )
            add(
        ...
        if install.returncode == 0:
            ...
            if installed_check.returncode == 0:
                try:
                    ...
                    add("installed_templates", installed_summary.get("template_count") == 5 and installed_summary.get("bundle_verified_count") == 5, "Installed wheel exposes all starter templates and verifies their bundles.", installed_check_dir / "release_check.json")
