        ...
        if launch_kit_summary.get("status") != "launch_kit_ready":
            ...
            launch_content_checks = {
                ...
                "launch_github_repo_profile": (
                    ...
                    ["Live AI eval downstream PR proof", "AI eval blocked CI run", "AI eval ready CI run", "Live RAG eval downstream PR proof", "RAG eval blocked CI run", "RAG eval ready CI run", "falsiflow-downstream-ai-eval-demo", "falsiflow-downstream-rag-eval-demo", "26711652990", "26711669112", "26721829145", "26721856616"],
                ),
                "launch_announcement": (
