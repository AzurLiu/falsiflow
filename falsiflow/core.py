...
def release_check_json_schema() -> dict[str, Any]:
    ...
    return {
        ...
        "required": [
            ...
            "claim_check_status",
            "claim_check_summary",
            "downstream_smoke_replay_status",
            "downstream_smoke_replay_summary",
            "schema_count",
        ...
        "properties": {
            ...
            "downstream_smoke_replay_status": {
                "type": "string",
                "enum": ["downstream_smoke_replay_ready", "downstream_smoke_replay_blocked", "downstream_smoke_replay_skipped"],
            },
            "downstream_smoke_replay_summary": {"type": "object"},
