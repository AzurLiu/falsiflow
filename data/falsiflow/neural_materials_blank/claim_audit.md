...
| `h_b_electrical_interface` | `blocked_missing_evidence` | 0 | 6 | 0 | 12 |
...
- `h_a_medium_stability` `ha_demo_001` `ph_initial`: missing evidence row
...
- `h_b_electrical_interface` `hb_demo_001` `impedance_1khz_control_ohm`: missing evidence row
...
- `h_b_electrical_interface` `hb_demo_001` `impedance_reduction_1khz_pct`: derived field failed: required input field is missing: impedance_1khz_control_ohm
...
- 2. `fill_h_b_electrical_interface_evidence` - Gate `h_b_electrical_interface` is `blocked_missing_evidence` with 12 blocker(s).
