# Cambridge Polymer Group H-A RFQ Send Confirmation Notes
...
`data/rfq_send_confirmation_files/h_a/cambridge_polymer_group_hydrogel_send_confirmation.txt`
...
- `candidate_id`: `cambridge_polymer_group_hydrogel`
...
- `send_method`: `request_quote_form_or_email`
- `recipient_or_form`: `info@campoly.com`
- `message_id_or_confirmation`: message ID, ticket ID, quote request ID, or form confirmation text
- `send_confirmation_source_file`: `data/rfq_send_confirmation_files/h_a/cambridge_polymer_group_hydrogel_send_confirmation.txt`
- `sent_bundle_sha256`: `bad885c9487cfc4e33c6abda168421232f8da5b1fc2a6698b4d129453d7811a1`
