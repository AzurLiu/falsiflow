# The Osmolality Lab H-A RFQ Reply Review Notes
...
`data/rfq_reply_files/h_a/the_osmolality_lab_reply.txt`
...
- `reply_source_file`: `data/rfq_reply_files/h_a/the_osmolality_lab_reply.txt`
