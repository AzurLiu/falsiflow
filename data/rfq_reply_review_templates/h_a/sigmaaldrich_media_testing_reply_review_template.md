# MilliporeSigma Cell Culture Media Stability and Testing Services H-A RFQ Reply Review Notes
...
`data/rfq_reply_files/h_a/sigmaaldrich_media_testing_reply.txt`
...
- `reply_source_file`: `data/rfq_reply_files/h_a/sigmaaldrich_media_testing_reply.txt`
