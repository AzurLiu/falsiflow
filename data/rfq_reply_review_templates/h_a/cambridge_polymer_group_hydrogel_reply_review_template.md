# Cambridge Polymer Group H-A RFQ Reply Review Notes
...
`data/rfq_reply_files/h_a/cambridge_polymer_group_hydrogel_reply.txt`
...
- `reply_source_file`: `data/rfq_reply_files/h_a/cambridge_polymer_group_hydrogel_reply.txt`
