# The Osmolality Lab ZRC-ND Phase A RFQ Reply Review Notes
...
`data/rfq_reply_files/zrc_phase_a/the_osmolality_lab_reply.txt`
...
- `reply_source_file`: `data/rfq_reply_files/zrc_phase_a/the_osmolality_lab_reply.txt`
