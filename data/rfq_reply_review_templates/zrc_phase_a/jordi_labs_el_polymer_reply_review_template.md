# Jordi Labs Analytical Testing ZRC-ND Phase A RFQ Reply Review Notes
...
`data/rfq_reply_files/zrc_phase_a/jordi_labs_el_polymer_reply.txt`
...
- `reply_source_file`: `data/rfq_reply_files/zrc_phase_a/jordi_labs_el_polymer_reply.txt`
