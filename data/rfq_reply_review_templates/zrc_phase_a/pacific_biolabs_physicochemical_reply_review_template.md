# Pacific BioLabs Physicochemical Properties Testing ZRC-ND Phase A RFQ Reply Review Notes
...
- `reply_source_file`: `data/rfq_reply_files/zrc_phase_a/pacific_biolabs_physicochemical_reply.txt`
